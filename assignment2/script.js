...
function game(){
  var p=this.myfun();
  if(p==1){
    document.getElementById('k').innerHTML="TIE";
  }
  if(p==2){
    document.getElementById('k').innerHTML="HUMAN SURVIVES";
  }
  if(p==3){
    document.getElementById('k').innerHTML="COCKROACH SURVIVES";
  }
  if(p==4){
    document.getElementById('k').innerHTML="HUMAN DIES";
  }
}
